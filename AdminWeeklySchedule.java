...
public class AdminWeeklySchedule extends javax.swing.JFrame {

    /**
     * Creates new form WeeklySchedule
     */
    public AdminWeeklySchedule() {
        initComponents();
        setSize(1100, 600);
        setResizable(false);
        buildLogoPanel();
...
*/
        ...
        groupPanel.setBackground(new Color(255, 249, 244)); //sets the panel background this light yellowish color
    ...
    private void buildLogoPanel() {
        ...
        newPassword.setFont(new Font("Verdana", Font.BOLD, 12));
        newPassword.setBackground(new Color(255, 255, 255));
        newPassword.setBorderPainted(false);
        newPassword.setCursor(new Cursor(Cursor.HAND_CURSOR));
...
public void removeUser(ArrayList<String> u, ArrayList<String> p) throws IOException{
    ...
    private void newPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newPasswordActionPerformed
        ...
        String input = JOptionPane.showInputDialog("Enter the password you want for your employee");
        PassEncrypt encrypter = new PassEncrypt();
        String encryptedPassword = encrypter.encrypt(input);
        JOptionPane.showMessageDialog(null, "Here is your encrypted password! Make sure to put it into the passwords file: " + encryptedPassword);
    }
/*
    private void logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newPasswordActionPerformed
        // TODO add your handling code here:
       try {
        Main mainGUI; 
        setVisible(false);
...
*/
    ...
    private void plusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plusBtnActionPerformed
       ...
       JComboBox startTime = new JComboBox(startTimes);
        ...
        try{
        String name;
        name = JOptionPane.showInputDialog("What is the email of the employee you want to schedule?");
       ...
       for (int i = 0; i < count; i++) {
        ...
        {
            JOptionPane.showMessageDialog(null, "No emloyee scheduled");
        }
    ...
    private void minusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_minusBtnActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Employee was not removed. Proper information not entered.");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminWeeklySchedule().setVisible(true);
            }
        });
